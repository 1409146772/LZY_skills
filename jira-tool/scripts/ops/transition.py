...
用法：
    D:/LZY_project/jira/.venv/Scripts/python.exe C:/Users/user/.claude/skills/jira-tool/scripts/ops/transition.py AERDM-123 --list
    D:/LZY_project/jira/.venv/Scripts/python.exe C:/Users/user/.claude/skills/jira-tool/scripts/ops/transition.py AERDM-123 --transition-id 31 --expect-status 进行中 --dry-run
    D:/LZY_project/jira/.venv/Scripts/python.exe C:/Users/user/.claude/skills/jira-tool/scripts/ops/transition.py AERDM-123 --transition-id 31 --resolution 完成 --comment "已完成"
