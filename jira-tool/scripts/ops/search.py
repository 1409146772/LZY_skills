...
用法：
    ...
    D:/LZY_project/jira/.venv/Scripts/python.exe C:/Users/user/.claude/skills/jira-tool/scripts/ops/search.py --project AERDM --status 进行中 --all --limit 500
    D:/LZY_project/jira/.venv/Scripts/python.exe C:/Users/user/.claude/skills/jira-tool/scripts/ops/search.py --jql "project=AERDM AND assignee=luziyu order by updated desc"
