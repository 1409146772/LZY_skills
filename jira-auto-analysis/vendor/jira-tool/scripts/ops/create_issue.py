...
用法：
    python ops/create_issue.py --project AESW --type 缺陷 --summary "标题" --data-only
    python ops/create_issue.py --project AERDM --type 任务 --summary "标题" --dry-run
    python ops/create_issue.py --project AERDM --type 任务 --data @D:/tmp/fields.json --dry-run
