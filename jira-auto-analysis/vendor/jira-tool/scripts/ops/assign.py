...
用法：
    python ops/assign.py AERDM-123 --list-assignable --query luzi
    python ops/assign.py AERDM-123 --user luziyu --dry-run
    python ops/assign.py AERDM-123 --unassign --dry-run
